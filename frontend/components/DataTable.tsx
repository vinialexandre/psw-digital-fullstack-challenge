        ...
        <div className="flex items-center px-0 py-3 border-b border-gray-200">
          {columns.map((column, index) => (
            <div
              ...
              className={`text-xs md:text-sm font-semibold text-gray-700 cursor-pointer hover:text-gray-900 ${
                index === 0 ? 'w-48 md:w-80' : index === 1 ? 'w-28 md:w-32 ml-2 md:ml-3' : 'w-28 md:w-32 ml-12 md:ml-24'
              }`}
